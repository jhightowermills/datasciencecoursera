...
(details taken from rprog-doc-ProgAssignment3.pdf in repo)
...
12. Comparison to U.S. Rate - Hospital 30-Day Death (Mortality) Rates from Heart Attack: varchar 
(50) Lists the mortality and readmission category in which the
